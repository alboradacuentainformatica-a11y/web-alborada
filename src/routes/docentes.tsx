...
const docentes = [
  ...
  { name: "Kely Marisol De La Cruz Rojas", role: "Docente", initials: "KMDR", photo: "K.M.ok.png"},
  { name: "Marilú Angelica Diaz Pillaca", role: "Docente", initials: "MADP", photo: "M.A.D.ok.png" },
  ...
  { name: "Sofía Catalina Roman De La Torre", role: "Docente", initials: "SCRDLT", photo: "S.C.R.T.ok.png" },
  ...
  { name: "Yene Betty Salinas Carhuaz", role: "Docente", initials: "YBSC", photo: "Y.S.C.ok.png" },
  { name: "Zandra Isidora Parra Otárola", role: "Docente", initials: "ZIPO", photo: "Z.P.O.ok.png" },
